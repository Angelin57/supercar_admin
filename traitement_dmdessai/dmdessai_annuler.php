            ...
            <div class="d-flex flex-column" id="content-wrapper">
                <div id="content">
                    ...
                    <div class="container-fluid">
                        <h3 class="text-dark mb-4">Liste des reservations&nbsp;<a href="../dmdessai.php"
                                class="btn btn-primary" style="font-size : 15px; margin-left: 180px">
                                En cours</a>
                            <a class="btn btn-primary"
                                style="font-size : 15px; margin-left: 180px; background-color: #1cc88a;"
                                href="dmdessai_terminer.php">
                                Terminer</a>
                            <a class="btn btn-primary"
                                style="font-size : 15px; margin-left: 180px; background-color: #FF5252; "
                                href="dmdessai_annuler.php">
                                Annuler</a>
                        </h3>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive table mt-2" id="dataTable" role="grid"
                                    ...
                                    <table class="table my-0" id="dataTable">
                                        ...
                                        $sql = "SELECT * FROM dmdessai WHERE statut = 'Annuler'";
                                        ...
                                        <thead>
                                            ...
                                            while ($row = mysqli_fetch_assoc($sql_client)) {
                                                ...
                                                <tr>
                                                    ...
                                                    <a href="modification.php?id_dmdessai=' . $row['id_dmdessai'] . '">
                                                    <i class="fas fa-pencil-alt fa-lg text-yellow-500"></i></a> &nbsp;
                                                    <a href="suppression.php?id_dmdessai=' . $row['id_dmdessai'] . '">
