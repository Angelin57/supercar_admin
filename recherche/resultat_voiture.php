                    ...
                    <nav class="navbar navbar-light navbar-expand bg-white shadow mb-4 topbar static-top">
                        <div class="container-fluid"><button class="btn btn-link d-md-none rounded-circle me-3"
                            ...
                            <form class="d-none d-sm-inline-block me-auto ms-md-3 my-2 my-md-0 mw-100 navbar-search"
                                action="resultat_voiture.php" method="GET">
                    ...
                    <div style="margin-left: 10px;">
                        <div class="container">
                            ...
                            if (isset($_GET['query'])) {
                                ...
                                // Connectez-vous à votre base de données (à personnaliser selon votre configuration).
                                include('../bdd/connexion_bdd.php');


                                // Utilisez la variable $resultat pour construire votre requête SQL de recherche.
                                $sql = "SELECT voiture.*, GROUP_CONCAT(image_voiture.sre) AS images
                                FROM voiture
                                INNER JOIN image_voiture ON voiture.id_voiture = image_voiture.id_voiture
                                WHERE voiture_marque = '$resultat' OR voiture_name = '$resultat' OR voiture_type = '$resultat'
                                ...
                                if ($result) {
                                    if (mysqli_num_rows($result) > 0) {
                                        ...
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            echo '            <a href="../liste_voiture/modification.php?id_voiture=' . $row['id_voiture'] . '" ><i class="fas fa-pencil-alt fa-lg text-yellow-500"></i></a> &nbsp';
                                            echo '            <a href="../liste_voiture/traitement_supprimer.php?id_voiture=' . $row['id_voiture'] . '"><i style="color: #FF5252;" class="fas fa-trash-alt fa-lg text-red-500"></i></a>';
                                            echo '        </div>';
                                            echo '    </li>';
                                        }
                                        ...
                                        echo '<div class="container-fluid " >
                                                <div class="text-center mt-5" style="margin-right:500px">
                                                    <div class="error mx-auto text-center" data-text="Aucun résultat trouvé pour : ' . $resultat . ' " style="font-size: 40px; white-space: nowrap; ">
                                                        <p class="m-0 text-center" style="text-align: center;">Aucun résultat trouvé pour : ' . $resultat . ' </p>
                                                    </div>
                                                </div>
                                    </div>';
                    ...
                    <div id="id01" class="w3-modal">
                        <div style="width: 500px; border-radius: 10px;"
                            ...
                            <div class="w3-container">
                                <form action="../liste_voiture/ajout_voiture.php" method="POST"
